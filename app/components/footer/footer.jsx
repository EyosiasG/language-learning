            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <a href="https://pagedone.io/" class="flex justify-center space-x-2 lg:justify-start">
                            <Image src={Logo} height={30} alt="Learn Master Logo" />
                            <h1 className="font-semibold text-lg">Learn Master</h1>
                        </a>
                        <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted in by our community. Have any query ?</p>
                    ...
                    <div class="lg:mx-auto text-left ">
                        <h4 class="text-lg text-gray-900 font-medium mb-7">Courses</h4>
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Amharic</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Tigrigna</a></li>
                            <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Oromiffa</a></li>
                        </ul>
                    </div>
                    <div class="lg:mx-auto text-left ">
